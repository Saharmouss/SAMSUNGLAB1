...
function validarClave(){
	...
	if(campocontra.value == 0){
		...
		return false; }
	else if(validclave.test(campocontra.value) ){
...
//comprobacion de confirmacion

function validarConfirm(){
	var campocontra = document.getElementById('Clave');
	var campoconfirm = document.getElementById('Confirmacion');
...
//comprobacion de que tod este ok 
